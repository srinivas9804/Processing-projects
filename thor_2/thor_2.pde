...
void draw() 
{
  ...
  fill(bl);//hair of person in quad3
  beginShape();  
  vertex(155,270);
  curveVertex(152,273);
  curveVertex(158,263);
  ...
  for(float i=0;i<=18;i=i+5.4)
  {
    quad(260,346+i,265,346+i,265,350+i,261,350+i);
  }
  for(float j=0,k=0;j<=18;j=j+5.4,k=k+2)
  {
